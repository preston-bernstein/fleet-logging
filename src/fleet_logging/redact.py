"""Defense-in-depth redaction — internal-infra CONVENTIONS.md §18 "Redaction".
...
internal-monitor-service's `_scrub()` (which internal-corpus-service's `logging_setup.py` did
