...
(internal-corpus-service, internal-monitor-service, internal-prediction-service). Rubric: Google's
...
- internal-infra `CONVENTIONS.md` §18 (the fleet logging contract this package
...
Consumers (internal-corpus-service, internal-monitor-service, internal-prediction-service) all pin to a
